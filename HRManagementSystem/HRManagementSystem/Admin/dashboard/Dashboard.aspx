<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dashboard.aspx.cs" Inherits="HRManagementSystem.Admin.dashboard.Dashboard" %>
                                        ...
                                        <div class="card mini-stats-wid">
                                            <div class="card-body">
                                                <div class="d-flex">
                                                    ...
                                                    <!--Start count Employee-->
                                                    <div class="flex-grow-1">
                                                        <p class="text-muted fw-medium">Employee</p>
                                                        <h4 class="mb-0">
                                                            <asp:Literal ID="employeeCountLiteral" runat="server" />
                                                        </h4>
                                                    </div>
                                                    <!--End count Employee-->
                                                    ...
                                                    <div class="flex-shrink-0 align-self-center">
                                                        <div class="mini-stat-icon avatar-sm rounded-circle bg-primary">
                                                            <span class="avatar-title">
                                                                <i class="bx bxs-user-voice font-size-24"></i>
                                                            </span>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="card mini-stats-wid">
                                            <div class="card-body">
                                                <div class="d-flex">
                                                    ...
                                                    <!--Start count Department-->
                                                    <div class="flex-grow-1">
                                                        <p class="text-muted fw-medium">Department</p>
                                                        <h4 class="mb-0">
                                                            <asp:Literal ID="departmentCountLiteral" runat="server" />
                                                        </h4>
                                                    </div>
                                                    <!--End count Department-->

                                                    <div class="flex-shrink-0 align-self-center ">
                                                        <div class="avatar-sm rounded-circle bg-primary mini-stat-icon">
                                                            <span class="avatar-title rounded-circle bg-primary">
                                                                <i class="bx bxs-institution font-size-24"></i>
                                                            </span>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="card mini-stats-wid">
                                            <div class="card-body">
                                                <div class="d-flex">
                                                    <div class="flex-grow-1">
                                                        <p class="text-muted fw-medium">Leave Records</p>
                                                        <h4 class="mb-0">
                                                            <asp:Literal ID="leaveRecordsCountLiteral" runat="server" />
                                                        </h4>
                                                    </div>
