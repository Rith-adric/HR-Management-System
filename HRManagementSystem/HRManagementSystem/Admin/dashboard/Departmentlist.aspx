<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DepartmentList.aspx.cs" Inherits="HRManagementSystem.Admin.dashboard.DepartmentList" %>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title mb-4">Department Table</h4>
                                        <asp:LinkButton ID="btnAddDepartment" runat="server" CssClass="btn btn-primary waves-effect btn-label waves-light" OnClick="btnAddDepartment_Click">
                                            <i class="bx bx-smile label-icon"></i> Add Department
                                        </asp:LinkButton>
                                        <br />
                                        <br />
                                        ...
                                        <div class="table-responsive">
                                            <asp:GridView ID="DepartmentGridView" runat="server" CssClass="table align-middle table-nowrap mb-0" AutoGenerateColumns="False" DataKeyNames="DepartmentID" OnRowEditing="DepartmentGridView_RowEditing" OnRowDeleting="DepartmentGridView_RowDeleting">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Department Name">
                                                        ...
                                                        <EditItemTemplate>
                                                            <asp:TextBox ID="DepartmentName" runat="server" Text='<%# Bind("DepartmentName") %>' />
                                                        </EditItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Manager ID">
                                                        ...
                                                        <EditItemTemplate>
                                                            <asp:TextBox ID="ManagerID" runat="server" Text='<%# Bind("ManagerID") %>' />
                                                        </EditItemTemplate>
                                                    </asp:TemplateField>
