<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmployeeList.aspx.cs" Inherits="HRManagementSystem.Admin.dashboard.EmployeeList" %>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <asp:LinkButton ID="btnAddEmployee" runat="server" CssClass="btn btn-primary waves-effect btn-label waves-light" OnClick="btnAddEmployee_Click">
                                            <i class="bx bx-smile label-icon"></i> Add Employee
                                        </asp:LinkButton>
                                        <br />
                                        <br />
                                        <asp:Literal ID="ltlMessage" runat="server"></asp:Literal>
                                        <div class="table-responsive">
                                            <asp:GridView ID="EmployeeGridView" runat="server" CssClass="table align-middle table-nowrap mb-0" AutoGenerateColumns="False" DataKeyNames="EmployeeID" OnRowEditing="EmployeeGridView_RowEditing" OnRowDeleting="EmployeeGridView_RowDeleting">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Department">
                                                        ...
                                                        <EditItemTemplate>
                                                            <asp:TextBox ID="Department" runat="server" Text='<%# Bind("Department") %>' />
                                                        </EditItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Position">
                                                        ...
                                                        <EditItemTemplate>
                                                            <asp:TextBox ID="Position" runat="server" Text='<%# Bind("Position") %>' />
                                                        </EditItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Date of Birth">
                                                        <ItemTemplate>
                                                            <%# Eval("DateOfBirth", "{0:dd MMM, yyyy}") %>
                                                        </ItemTemplate>
                                                        <EditItemTemplate>
                                                            <asp:TextBox ID="DateOfBirth" runat="server" Text='<%# Bind("DateOfBirth", "0:dd MMM, yyyy") %>' />
                                                        </EditItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="Salary">
                                                        ...
                                                        <EditItemTemplate>
                                                            <asp:TextBox ID="Salary" runat="server" Text='<%# Bind("Salary") %>' />
                                                        </EditItemTemplate>
                                                    </asp:TemplateField>
