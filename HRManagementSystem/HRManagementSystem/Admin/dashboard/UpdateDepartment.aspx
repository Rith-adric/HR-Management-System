<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateDepartment.aspx.cs" Inherits="HRManagementSystem.Admin.dashboard.UpdateDepartment" %>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <h4 class="card-title mb-4">Update Department</h4>
                                        <asp:Literal ID="ltlMessage" runat="server"></asp:Literal>
                                        <div class="row mb-4" runat="server">
                                            <asp:Label runat="server" CssClass="col-sm-3 col-form-label">Department ID</asp:Label>
                                            <div class="col-sm-9">
                                                <asp:TextBox runat="server" ID="DepartmentID" CssClass="form-control" placeholder="Department ID" ReadOnly="True"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="row mb-4" runat="server">
                                            <asp:Label runat="server" CssClass="col-sm-3 col-form-label">Department Name</asp:Label>
                                            <div class="col-sm-9">
                                                <asp:TextBox ID="DepartmentName" runat="server" CssClass="form-control" placeholder="Department Name"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="row mb-4">
                                            <asp:Label runat="server" CssClass="col-sm-3 col-form-label">Manager ID</asp:Label>
                                            <div class="col-sm-9">
                                                <asp:DropDownList ID="manager" runat="server" AppendDataBoundItems="true">
                                        ...
                                        <div class="row justify-content-end">
                                            <div class="col-sm-9">
                                                <div>
                                                    <asp:Button runat="server" ID="updateButton" Text="Update" CssClass="btn btn-outline-success waves-effect waves-light" OnClick="btnUpdate_Click" />
