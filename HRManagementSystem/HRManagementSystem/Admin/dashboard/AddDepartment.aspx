<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddDepartment.aspx.cs" Inherits="HRManagementSystem.Admin.dashboard.AddDepartment" %>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title mb-4">Insert Department</h4>
                                            <asp:Literal ID="ltlMessage" runat="server"></asp:Literal>
                                            <div class="row mb-4">
                                                <asp:Label runat="server" CssClass="col-sm-3 col-form-label">Department Name</asp:Label>
                                                <div class="col-sm-9">
                                                    <asp:TextBox runat="server" ID="DepartmentName" CssClass="form-control" placeholder="Enter Department Name"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="row mb-4">
                                            ...
                                            <div class="row justify-content-end">
                                                <div class="col-sm-9">
                                                    <div>
                                                        <asp:Button runat="server" ID="submitDeptButton" Text="Submit" CssClass="btn btn-outline-success waves-effect waves-light" OnClick="AddDepartment_Click" />
                                                        <asp:LinkButton ID="btnBackDept" runat="server" CssClass="btn btn-outline-primary waves-effect waves-light" OnClick="BackDepartment_Click">
                                                            &lt;&lt; Back
                                                        </asp:LinkButton>
                                                    </div>
                                                </div>
