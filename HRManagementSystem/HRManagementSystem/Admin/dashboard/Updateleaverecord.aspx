<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Updateleaverecord.aspx.cs" Inherits="HRManagementSystem.Admin.dashboard.Updateleaverecord" %>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title mb-4">Update Leave Record</h4>
                                            <asp:Literal ID="ltlMessage" runat="server"></asp:Literal>

                                            <div class="row mb-4">
                                                <asp:Label runat="server" CssClass="col-sm-3 col-form-label">Request ID</asp:Label>
                                                <div class="col-sm-9">
                                                    <asp:Label ID="RequestIDLabel" runat="server" CssClass="form-control" ReadOnly="True"></asp:Label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row justify-content-end">
                                                <div class="col-sm-9">
                                                    <div>
                                                        <asp:Button runat="server" ID="submitUpdateButton" Text="Update" CssClass="btn btn-outline-success waves-effect waves-light" OnClick="UpdateLeaveRecord_Click" />
